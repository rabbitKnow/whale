...
public class DataNode extends Configured 
  ...
  void startDataNode(Configuration conf, 
    ...
    MetaLog.info("RegistrationID:"+dnRegistration.getRegistrationID());
    ...
    if (simulatedFSDataset) {
      ...
      // read storage info, lock data dirs and transition fs state if necessary
    	...
    	MetaLog.info("storageInfo:"+storage.getNamespaceID()+"-"+storage.getLayoutVersion()+"-"+storage.getCTime());
  ...
  public static void setNewStorageID(DatanodeRegistration dnReg) {
    ...
    /**
     * TODO using ip+port for identify
     *original  "DS-" + rand + "-"+ ip + "-" + dnReg.getPort() + "-" + 
                      System.currentTimeMillis();
     * @author cokez
     */
    dnReg.storageID = "DS-" + ip + "-" + dnReg.getPort() ;
    
    MetaLog.info("dnreg:"+dnReg.storageID);
  }
  /**
   * Register datanode
   * <p>
  ...
  public void offerService() throws Exception {
     //@cokeZ using 120s for test blockReport
	  blockReportInterval=120*1000L;
